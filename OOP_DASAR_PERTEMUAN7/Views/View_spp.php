            ...
            <?php
                ...
                if(isset($GetSpp))
                {
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="../Views/View_put_spp.php?id_spp=<?php echo base64_encode($Get['id_spp']) ?>"><img src= "../img/mata.png" style = "width : 40px"></a>
                    <a onclick="konfirmasi(<?php echo $Get['id_spp'] ?>)"><img src="../img/sampah.png" style="width:40px"></a>
                </td>
            </tr>
    <?php
        }
