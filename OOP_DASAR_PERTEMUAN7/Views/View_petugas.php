            ...
            <?php
                ...
                if(isset($GetPetugas))
                {
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="../Views/View_put_petugas.php?id_petugas=<?php echo base64_encode($Get['id_petugas']) ?>"><img src = "../img/mata.png" style = "width : 40px"></a>
                    <a onclick="konfirmasi(<?php echo $Get['id_petugas'] ?>)"><img src = "../img/sampah.png" style = "width : 40px"></a>
                </td>
            </tr>
    <?php
        }
