...
<table border="1">
    ...
    <tr>
        <td>Tanggal Bayar</td>
        <td><input type="text" name="tgl_bayar" value="<?php echo $Get['tgl_bayar']; ?>"onKeyPress="return ValidateAlpha(event);" required></td>
    </tr>
    ...
    <tr>
        <td>Tahun Bayar</td>
        <td><input type="text" name="tahun_bayar" value="<?php echo $Get['tahun_bayar']; ?>"onKeyPress="return ValidateAlpha(event);" required></td>
    </tr>
    ...
    <tr>
        <td>Jumlah Bayar</td>
        <td><input type="text" name="jumlah_bayar" value="<?php echo $Get['jumlah_bayar'] ?>" onKeyPress="return ValidateAlpha(event);" required></td>
    </tr>
